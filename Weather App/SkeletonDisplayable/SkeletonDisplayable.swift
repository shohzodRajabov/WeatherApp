...
extension SkeletonDisplayable where Self: UIViewController {
    ...
    func showSkeleton() {
        ...
        let highlightColor = UIColor(red: 52/256, green: 109/256, blue: 179/256, alpha: 1).cgColor // UIColor(red: 235.0/255.0, green: 235.0/255.0, blue: 235.0/255.0, alpha: 1.0).cgColor
        ...
        skeletons.forEach {
            ...
            skeletonLayer.frame = UIScreen.main.bounds
